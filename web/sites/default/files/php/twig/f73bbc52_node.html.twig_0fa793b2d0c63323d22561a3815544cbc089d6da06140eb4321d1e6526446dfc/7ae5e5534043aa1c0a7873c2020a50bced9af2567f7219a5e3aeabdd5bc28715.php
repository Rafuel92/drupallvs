...
/* themes/contrib/breeze/templates/node.html.twig */
class __TwigTemplate_12e7e5ac22f56dc4229f73da009bd4906f0d9522cc49346130ab993bbf3d9e83 extends Twig_Template
{
  ...
  ";
        ...
        if ( !(isset($context["page"]) ? $context["page"] : null)) {
            // line 72
            echo "    <h2";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["title_attributes"]) ? $context["title_attributes"] : null), "addClass", array(0 => "page-header"), "method"), "html", null, true));
            echo ">
      <a href=\"";
            // line 73
...
";
    ...
    {
        return "themes/contrib/breeze/templates/node.html.twig";
    }
...
<article{{ attributes }}>
  ...
  {{ title_prefix }}
  {% if not page %}
    <h2{{ title_attributes.addClass('page-header') }}>
...
", "themes/contrib/breeze/templates/node.html.twig", "/Users/raffaelechiocca/PhpstormProjects/ivs/web/themes/contrib/breeze/templates/node.html.twig");
    }
}
