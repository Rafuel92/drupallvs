...
(isset($context["plugin_id"]) ? $context["plugin_id"] : null))));
  ...
  ";
        ...
        if ((isset($context["label"]) ? $context["label"] : null)) {
            // line 47
            echo "    <h2";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["title_attributes"]) ? $context["title_attributes"] : null), "addClass", array(0 => "visually-hidden"), "method"), "html", null, true));
            echo ">";
...
", "themes/contrib/bootstrap/templates/block/block--search.html.twig", "/Users/raffaelechiocca/PhpstormProjects/ivs/web/themes/contrib/bootstrap/templates/block/block--search.html.twig");
    }
}
