...
/* themes/contrib/breeze/templates/menu-local-tasks.html.twig */
class __TwigTemplate_d68abf6dc4cefa75f9582896646cb33063e110e9794c711cfc2038f6be55e15d extends Twig_Template
{
...
";
        ...
        if ((isset($context["secondary"]) ? $context["secondary"] : null)) {
            ...
            echo "</h2>
  <ul class=\"nav nav-tabs secondary-tabs clearfix\">";
            // line 22
...
";
    ...
    {
        return "themes/contrib/breeze/templates/menu-local-tasks.html.twig";
    }
...
{% if primary %}
  ...
  <ul class=\"nav nav-tabs primary-tabs clearfix\">{{ primary }}</ul>
{% endif %}
{% if secondary %}
  <h2 class=\"visually-hidden\">{{ 'Secondary tabs'|t }}</h2>
  <ul class=\"nav nav-tabs secondary-tabs clearfix\">{{ secondary }}</ul>
{% endif %}
", "themes/contrib/breeze/templates/menu-local-tasks.html.twig", "/Users/raffaelechiocca/PhpstormProjects/ivs/web/themes/contrib/breeze/templates/menu-local-tasks.html.twig");
    }
}
