...
class __TwigTemplate_dc071b48c9599e8f738d091a25fcb216f054a4c232faea5afab70ae80b9f1590 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<div class=\"block-filter-text-source\">{{ label }}</div>", "{# inline_template_start #}<div class=\"block-filter-text-source\">{{ label }}</div>", "");
    }
}
