...
/* themes/contrib/breeze/templates/status-messages.html.twig */
class __TwigTemplate_c4b501d6ebc04adf0eeefff4b46f8a96678d661219debd9cc8cec02765749a56 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["type"] => $context["messages"]) {
            // line 27
            echo "  <div role=\"contentinfo\" class=\"message-box\" aria-label=\"";
...
";
    ...
    {
        return "themes/contrib/breeze/templates/status-messages.html.twig";
    }
...
{% for type, messages in message_list %}
  <div role=\"contentinfo\" class=\"message-box\" aria-label=\"{{ status_headings[type] }}\"{{ attributes|without('role', 'aria-label') }}>
    {% if type == 'error' %}
      <div role=\"alert\">
    {% endif %}
...
{% endfor %}
", "themes/contrib/breeze/templates/status-messages.html.twig", "/Users/raffaelechiocca/PhpstormProjects/ivs/web/themes/contrib/breeze/templates/status-messages.html.twig");
    }
}
